...
export default function LeaderboardTable({
  ...
  const exportCSV = () => {
    ...
    const rows = candidates.map((c) => [
      ...
      c.score?.required_skill_fit,
      c.score?.preferred_skill_fit,
      c.score?.experience_fit ?? 'N/A',
        ...
        <table className="custom-table">
          ...
          <tbody>
            {filteredCandidates.map((cand) => {
              const isDegraded = !cand.validation?.ok || cand.validation?.extraction_status !== 'ok';
